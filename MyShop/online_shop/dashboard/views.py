...
# View to display all products, accessible only to managers
...
# View to add a new product, accessible only to managers
@user_passes_test(is_manager)
@login_required
...
# View to delete a product by ID, accessible only to managers
@user_passes_test(is_manager)
@login_required
...
# View to edit an existing product by ID, accessible only to managers
@user_passes_test(is_manager)
@login_required
...
# View to add a new category, accessible only to managers
@user_passes_test(is_manager)
@login_required
...
# View to display all orders, accessible only to managers
@user_passes_test(is_manager)
@login_required
def orders(request):
...
# View to display order details by ID, accessible only to managers
@user_passes_test(is_manager)
@login_required
